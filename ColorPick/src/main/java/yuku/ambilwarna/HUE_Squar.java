...
public class HUE_Squar extends View {
	Paint paint;
	Shader luar;
	final float[] color = { 1.f, 1.f, 1.f };

	public HUE_Squar(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public HUE_Squar(Context context, AttributeSet attrs, int defStyle) {
