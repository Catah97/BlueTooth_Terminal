...
public class Control extends Fragment implements View.OnClickListener,CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final SwitchCompat switch1 = (SwitchCompat) rootView.findViewById(R.id.switch1);
        final SwitchCompat switch2 = (SwitchCompat) rootView.findViewById(R.id.switch2);
        final SwitchCompat switch3 = (SwitchCompat) rootView.findViewById(R.id.switch3);
        final SwitchCompat switch4 = (SwitchCompat) rootView.findViewById(R.id.switch4);
        final SwitchCompat switch5 = (SwitchCompat) rootView.findViewById(R.id.switch5);
        final SwitchCompat switch6 = (SwitchCompat) rootView.findViewById(R.id.switch6);
        final SwitchCompat switch7 = (SwitchCompat) rootView.findViewById(R.id.switch7);
        final SwitchCompat switch8 = (SwitchCompat) rootView.findViewById(R.id.switch8);
        final SwitchCompat switch9 = (SwitchCompat) rootView.findViewById(R.id.switch9);
        final SwitchCompat switch10 = (SwitchCompat) rootView.findViewById(R.id.switch10);
